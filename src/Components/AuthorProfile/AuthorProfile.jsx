  ...
  return (
    <div className='py-20'>
       <div className='max-w-[1700px] mx-auto px-5 md:px-10'>
                ...
                <div className='relative'>
                    <div className='w-full md:w-1/2 md:absolute md:right-0  bg-white p-5 rounded-lg shadow-md'>
                        ...
                        <div className='flex items-center gap-4 border-b py-2'>
                            ...
                            <p className='text-base'>ridoysharif11@gmail.com</p>
                        </div>
                        <div className='flex items-center gap-4 border-b py-2'>
                            <div className='text-white border bg-blog-primary rounded-full p-2'>
            ...
            <div className='mt-20'>
                <div>
                    <h1 class="text-2xl font-semibold mb-7">All Blog</h1>
                </div>
